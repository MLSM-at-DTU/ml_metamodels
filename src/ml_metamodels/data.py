        ...
        for split in ["train", "val", "test"]:
            ...
            for graph in graphs:
                ...
                graph.x = torch.tensor(
                    node_scaler.transform(graph.x.flatten().reshape(-1, 1)).reshape(graph.x.shape), dtype=torch.float32
                )
...
<<<<<<< HEAD:src/ml_project/data.py

=======
>>>>>>> 863eaef25e23310174cc71491df77881239f6e76:src/ml_metamodels/data.py
